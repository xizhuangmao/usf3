...
<title>News</title>
	...
	<!-- 实例化编辑器 -->  
   	<script type="text/javascript">
		...
		editor.render("addHelpNews_container");
		var ue = UE.getEditor("addHelpNews_container");
	</script>

	<script type="text/javascript">
		$(function(){
			$("#addHelpNews_save").click(function(){
				var title = $("#addHelpNewsTitle_container").val();
				var content = ue.getContent();
				if(title.length==0 || content.length==0){
					$.messager.alert('Warning','Please enter a title or content');
				}else{
					$.ajax({
						url : '${pageContext.request.contextPath}/newsAction!addHelpNews.action',
						type : 'post',
						data : {"title" : title, "content":content},
						dataType : 'text',
						success : function(data){
							var obj = $.parseJSON(data);
							$("#addHelpNews_dialog").dialog('open');
							$("#addHelpNewsTitle_container").val("");
							ue.ready(function() {
								ue.setContent("");
							});
						}
			...
			$("#addHelpNews_back").click(function(){
...
<div class="title" style="text-align: center">
	<h1><textarea id="addHelpNewsTitle_container" name="addHelpNewsTitle_container" style="width: 836px;font-size: 30px;text-align: center; resize: none"></textarea></h1>
</div>
...
<div class="main" id="two-columns">
	...
	<div class="bottom" style="height: 650px;width: 850px">
		...
		<div class="left" >
			...
			<table class="block">
				<tr>
  					<td><textarea id="addHelpNews_container" name="addHelpNews_container" style="width: 836px;"></textarea></td>
  				</tr>
			</table>
		</div>
		<!-- <img src="../images/back1.png" id="addHelpNews_back" style="color: black;cursor:pointer;"/> -->
		<img src="../../images/save.png" id="addHelpNews_save" style="color: black;cursor:pointer;"/>
	</div>
</div>
	...
	<div id="addHelpNews_dialog" style="width: 220px;height: 120px" class="easyui-dialog"
		...
		<div style="width: 200px;height: 30px;padding-top: 10px" align="center">
			<a onclick="$('#addHelpNews_dialog').dialog('close');"><img src="../../images/continueadd.png"></a>			
		</div>
		<div style="width: 200px;height: 20px;" align="center">
			<a onclick="$('#addHelpNews_dialog').dialog('destroy');javascript:self.close();"><img src="../../images/closePage.png"></a>			
		</div>
	</div>
</html>

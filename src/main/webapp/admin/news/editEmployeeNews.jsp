...
<title>News</title>
	...
	<!-- 实例化编辑器 -->  
   	<script type="text/javascript">
		...
		editor.render("editEmployee_container");
		var ue = UE.getEditor("editEmployee_container");
	</script>
		...
		$(function(){
 			$.ajax({
				...
				success : function(data){
					...
					$("#editEmployeeTitle_container").val(obj.title);
				}
			});
 			
			$("#editEmployeeNews_save").click(function(){
				var title = $("#editEmployeeTitle_container").val();
				...
				if(title.length==0 || content.length==0){
					...
					$.ajax({
						...
						success : function(data){
							...
							$("#editEmployeeNews_dialog").dialog('open');
						}
					});
				}
			});
...
<div class="title" style="text-align: center">
	<h1><textarea id="editEmployeeTitle_container" name="editEmployeeTitle_container" style="width: 836px;font-size: 30px;text-align: center; resize: none"></textarea></h1>
</div>
...
<div class="main" id="two-columns">
	...
	<div class="bottom" style="height: 650px;width: 850px">
		...
		<div class="left" >
			...
			<table class="block">
				<tr>
  					<td><textarea id="editEmployee_container" name="editEmployee_container" style="width: 836px;"></textarea></td>
  				</tr>
			</table>
		</div>
		<img src="../../images/save.png" id="editEmployeeNews_save" style="color: black;cursor:pointer;"/>
	</div>
</div>
	...
	<div id="editEmployeeNews_dialog" style="width: 220px;height: 120px" class="easyui-dialog"
		...
		<div style="width: 200px;height: 30px;padding-top: 10px" align="center">
			<a onclick="$('#editEmployeeNews_dialog').dialog('close');"><img src="../../images/continuemodify.png"></a>			
		</div>
		<div style="width: 200px;height: 20px;" align="center">
			<a onclick="$('#editEmployeeNews_dialog').dialog('destroy');javascript:self.close();"><img src="../../images/closePage.png"></a>			
		</div>
	</div>
</html>

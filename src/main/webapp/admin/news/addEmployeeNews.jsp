...
<link rel="stylesheet" href="${pageContext.request.contextPath}/style/firststyle.css" type="text/css" media="screen"></link>
	...
	<!-- 实例化编辑器 -->  
   	<script type="text/javascript">
		...
		editor.render("addEmployee_container");
		var ue = UE.getEditor("addEmployee_container");
	</script>

	<script type="text/javascript">
		$(function(){
			$("#addEmployeeNews_save").click(function(){
				var title = $("#addEmployeeTitle_container").val();
				var content = ue.getContent();
				if(title.length==0 || content.length==0){
					$.messager.alert('Warning','Please enter a title or content');
				}else{
					$.ajax({
						url : '${pageContext.request.contextPath}/newsAction!addEmployeeNews.action',
						type : 'post',
						data : {"title" : title, "content":content},
						dataType : 'text',
						success : function(data){
							var obj = $.parseJSON(data);
							$("#addEmployeeNews_dialog").dialog('open');
							$("#addEmployeeTitle_container").val("");
							ue.ready(function() {
								ue.setContent("");
							});
						}
			...
			$("#addEmployeeNews_back").click(function(){
...
<div class="title" style="text-align: center">
	<h1><textarea id="addEmployeeTitle_container" name="addEmployeeTitle_container" style="width: 836px;font-size: 30px;text-align: center; resize: none"></textarea></h1>
</div>
...
<div class="main" id="two-columns">
	...
	<div class="bottom" style="height: 650px;width: 850px">
		...
		<div class="left" >
			...
			<table class="block">
				<tr>
  					<td><textarea id="addEmployee_container" name="addEmployee_container" style="width: 836px;"></textarea></td>
  				</tr>
			</table>
		</div>
		<!-- <img src="../images/back1.png" id="addEmployeeNews_back" style="color: black;cursor:pointer;"/> -->
		<img src="../../images/save.png" id="addEmployeeNews_save" style="color: black;cursor:pointer;"/>
	</div>
</div>
	...
	<div id="footer" align="center"> 
		...
		<div id="addEmployeeNews_dialog" style="width: 220px;height: 120px" class="easyui-dialog"
		...
		<div style="width: 200px;height: 30px;padding-top: 10px" align="center">
			<a onclick="$('#addEmployeeNews_dialog').dialog('close');"><img src="../../images/continueadd.png"></a>			
		</div>
		<div style="width: 200px;height: 20px;" align="center">
			<a onclick="$('#addEmployeeNews_dialog').dialog('destroy');javascript:self.close();"><img src="../../images/closePage.png"></a>			
		</div>
	</div>
</html>

...
<title>News</title>
	...
	<!-- 实例化编辑器 -->  
   	<script type="text/javascript">
		...
		editor.render("editHelpNews_container");
		var ue = UE.getEditor("editHelpNews_container");
	</script>

	<script type="text/javascript">
		$(function(){
 			$.ajax({
				url : '${pageContext.request.contextPath}/newsAction!findHelpNewsById.action',
				...
				success : function(data){
					...
					$("#editHelpNewsTitle_container").val(obj.title);
				}
			});
 			
			$("#editHelpNews_save").click(function(){
				var title = $("#editHelpNewsTitle_container").val();
				var content = ue.getContent();
				if(title.length==0 || content.length==0){
					alert("Please enter a title or content");
				}else{
					$.ajax({
						url : '${pageContext.request.contextPath}/newsAction!editHelpNewsById.action',
						type : 'post',
						data : {"id": '<%= request.getParameter("id")%>', "title" : title, "content":content},
						dataType : 'text',
						success : function(data){
							var obj = $.parseJSON(data);
							$("#editHelpNews_dialog").dialog('open');
						}
					});
				}
			});
			
			$("#editHelpNews_back").click(function(){
...
<div class="title" style="text-align: center">
	<h1><textarea id="editHelpNewsTitle_container" name="editHelpNewsTitle_container" style="width: 836px;font-size: 30px;text-align: center; resize: none"></textarea></h1>
</div>
...
<div class="main" id="two-columns">
	...
	<div class="bottom" style="height: 650px;width: 850px">
		...
		<div class="left" >
			...
			<table class="block">
				<tr>
  					<td><textarea id="editHelpNews_container" name="editHelpNews_container" style="width: 836px;"></textarea></td>
  				</tr>
			</table>
		</div>
	<!-- <img src="../images/back1.png" id="editHelpNews_back" style="color: black;cursor:pointer;"/> -->
	<img src="../../images/save.png" id="editHelpNews_save" style="color: black;cursor:pointer;"/>
	</div>
</div>
	...
	<div id="editHelpNews_dialog" style="width: 220px;height: 120px" class="easyui-dialog"
		...
		<div style="width: 200px;height: 30px;padding-top: 10px" align="center">
			<a onclick="$('#editHelpNews_dialog').dialog('close');"><img src="../../images/continuemodify.png"></a>			
		</div>
		<div style="width: 200px;height: 20px;" align="center">
			<a onclick="$('#editHelpNews_dialog').dialog('destroy');javascript:self.close();"><img src="../../images/closePage.png"></a>			
		</div>
	</div>
</html>
